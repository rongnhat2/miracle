        ...
        __generateDTRow(data){
            ...
            return [
                ...
                `<div class="d-flex align-items-center">
                    ...
                    <div>Đơn giá: ${IndexView.table.formatNumber(data.sub_total)} $</div>
                </div> 
                <div class="d-flex align-items-center">
                    <div class="badge badge-secondary badge-dot m-r-10"></div>
                    <div>Giảm giá: ${IndexView.table.formatNumber(data.discount_total)} $ </div>
                </div>
                <div class="d-flex align-items-center">
                    <div class="badge badge-success badge-dot m-r-10"></div>
                    <div>Thực tính: ${IndexView.table.formatNumber(data.total)} $</div>
                </div>`,
                data.created_at,
