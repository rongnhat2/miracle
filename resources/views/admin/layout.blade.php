...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('manager/assets/css/icomoon.css') }}">
...
<body>
            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="/" class="logo-title"> 
                        <span class="logo-full">Miracles</span>
                        <span class="logo-part">M</span> 
                    </a>
                </div>
                <div class="nav-wrap">
                    <ul class="nav-left">
    ...
    <script src="{{ asset('manager/assets/js/icon.js') }}"></script>
    {{-- Modal Template JS --}}
